    ...
    <>
      <div className="new-chat-user-info-card">
        <div className="new-chat-user-info-cover-img-sec">
          <CustomLazyLoad
            src={props.selectedUser.is_admin ? window.location.origin +
              "/assets/images/creator-list/creator-list-img-1.png" : props.selectedUser.cover}
        ...
        <div className="new-chat-user-info-item">
          <div>
            ...
            {!props.selectedUser.is_admin ? <Link to={`/${props.selectedUser.username}`}>
