...
import { changeChatAudio, chatMessageDeleteStart, updateChatMessagesSuccess } from '../../store/actions/ChatAction';
...
const SendChat = ({ message, handleSocketDelete }) => {
  ...
  const chatMessageDelete = useSelector(state => state.chat.chatMessageDelete);
  ...
  const handleChatDelete = () => {
    if (window.confirm("Delete this message?")) {
      dispatch(chatMessageDeleteStart(message.chat_message_id ? { chat_message_id: message.chat_message_id } : {chat_reference_id: message.chat_message_reference_id}));
