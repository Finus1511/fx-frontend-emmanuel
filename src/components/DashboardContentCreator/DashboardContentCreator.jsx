            ...
            <Row>
              ...
              <Col xl={3} lg={3} md={6} sm={6}>
                <div className="dashboard-card bg-green">
                  ...
                  <div className="dashboard-content">
                    <h6>{t("live_video_payments")}</h6>
                    <p>{props.dashboard.data.live_stream_shopping_payments}</p>
                  </div>
                </div>
              </Col>
              <Col xl={3} lg={3} md={6} sm={6}>
                <div className="dashboard-card bg-green">
                  ...
                  <div className="dashboard-content">
                    <h6>{t("live_stream_product_revenue")}</h6>
                    <p>{props.dashboard.data.lss_product_payments}</p>
                  </div>
                </div>
              </Col>
            </Row>
