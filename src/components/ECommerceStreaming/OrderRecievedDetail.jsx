...
import { lssProductOrdersRecievedListStart } from "../../store/actions/ProductLiveStreamAction";
...
const OrderRecievedDetail = () => {
  ...
  const productOrderList = useSelector(
    (state) => state.productLiveStream.lssProductOrdersRecievedList
  );
  ...
  useEffect(() => {
    dispatch(
      lssProductOrdersRecievedListStart({
        ...filter,
        skip: skip,
        take: take,
        live_stream_shopping_unique_id: params.unique_id,
      })
    );
  }, [skip, filter]);
      ...
      <Container fluid>
        {productOrderList.loading ? (
          ...
          <div className="personalized-request-box">
                        ...
                        onSubmit={(val) => {
                          ...
                          history.push(
                            searchParams.get("sort_by")
                              ? `/order-recieved-detail/${params.unique_id}?search_key=${val.search_key
                                  ...
                                  <InputGroup.Text id="basic-addon1">
                                    <Button
                                      ...
                                      onClick={() => {
                                        ...
                                        history.push(
                                          searchParams.get("sort_by")
                                            ? `/order-recieved-detail/${params.unique_id}?sort_by=${searchParams.get(
                                              "sort_by"
                                            )}`
                                            : `/order-recieved-detail/${params.unique_id}`
                                        );
                                      }}
                                    >
                                      <svg
            ...
            {Object.keys(productOrderList.data).length > 0 &&
            Object.keys(
              productOrderList.data.lss_products_recieved_order_details
            ).length > 0 ? (
              <Row>
                <Col md={12}>
                  <InfiniteScroll
                  ...
                  >
                    <div className="order-placed-box">
                      {productOrderList.data.lss_products_recieved_order_details.map(
                        (product) => (
                            ...
                            <div className="order-placed-card-head">
                              ...
                              <div className="order-placed-card-right">
                                <div className="order-placed-card-info">
                                  ...
                                  <Link
                                    to={`/single-order-view/${product.unique_id}`}
                                  >
                            ...
                            <div className="order-placed-card-body">
                              ...
                              <div className="shiping-status">
                                <span className="shiping-status-badge">
                                  <p>
                                    {product.shipping_url !== undefined &&
...
export default translate(OrderRecievedDetail);
