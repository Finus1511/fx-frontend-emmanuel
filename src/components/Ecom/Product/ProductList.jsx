                          ...
                          <tr className="alert" role="alert">
                            ...
                            <td>
                              ...
                              <Button
                                type="button"
                                className="view"
                                href={"/single-product/" + product.user_product_unique_id}
                              >
                                <span>
                              ...
                              <Link
                                to={`/view-order/${product.user_product_unique_id}/${product.user_product_id}`}
                                className="single-orders-view"
                              >
                                <span>{t("view_orders")}</span>
                              </Link>
                              <Link
                                to={`/product-gallery/${product.user_product_unique_id}/${product.user_product_id}`}
                                className="single-orders-view"
                              >
                                <span>{t("gallery")}</span>
                              </Link>
