...
import { creatorVirtualBookingStartStart } from "../../store/actions/CreatorOneOnOneVEAction";
const $ = window.$;
    ...
    >
        <>
          <Modal.Header closeButton>
            <Modal.Title>Virtual Experience One On One Booking</Modal.Title>
          </Modal.Header>
                    ...
                    <Form>
                      ...
                      >
                        <Form.Control
                          ...
                          value={props?.virtualExperiences.amount_formatted}
                          disabled
                        />
                      </Form.Group>
                      <Tab.Content>
