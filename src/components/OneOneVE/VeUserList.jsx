...
import { userVirtualVhListStart } from "../../store/actions/UserOneOnOneVEAction";
...
const VeUserList = () => {
	...
	const userVirtualVhList = useSelector(
		(state) => state.userOneOnOneVirtual.userVirtualVhList
	);
...
export default withRouter(VeUserList);