      ...
      <div className="premium-folder-list-box">
        <div className="premium-folder-list-card">
          <div className="folder-list-card-img-sec">
            <Image
              src="assets/images/phase4/folder-preview3.png"
          ...
          <div className="folder-list-card-img-info">
            ...
            <p>
              The list goes on and on. Because we know that you're pressing
              questions
            </p>
            <h3>567.00 Tokens</h3>
          </div>
        ...
        <div className="premium-folder-list-card">
          <div className="folder-list-card-img-sec">
            <Image
              src="assets/images/phase4/folder-preview1.png"
              className="folder-list-card-img"
            />
          </div>
          <div className="folder-list-card-action">
        ...
        <div className="premium-folder-list-card">
          <div className="folder-list-card-img-sec">
            <Image
              src="assets/images/phase4/folder-preview2.png"
              className="folder-list-card-img"
            />
          </div>
          <div className="folder-list-card-action">
