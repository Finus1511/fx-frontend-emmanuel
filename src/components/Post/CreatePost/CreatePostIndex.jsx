  ...
  const handleAudiopreviewImage = (event) => {
    if (event.currentTarget.type === "file") {
      ...
      reader.onloadend = () => {
        setAudioThumbnail({
          ...audioThumbnail,
          audioPreviewImage: reader.result,
        });
      };
                ...
                <Col sm={12} md={6} className="mt-3 mt-lg-4">
                  ...
                  {audioThumbnailStatus === true ? (
                    <>
                      ...
                      {audioThumbnail.audioPreviewImage !== "" ? (
                        <Row>
                          <Col sm={12} md={6} className="mb-3 mb-lg-4">
                            <div className="post-img-preview-sec m-0">
                              <Link
                                to="#"
                                onClick={() => setAudioThumbnail({
                                  audioPreviewImage: ""
                                })}
                              >
                                <i className="far fa-times-circle"></i>
                              ...
                              <Image
                                alt="#"
                                src={audioThumbnail.audioPreviewImage}
                                className="post-video-preview"
                              />
                            </div>
                          </Col>
                ...
                <Col sm={12} md={6} className="mt-3 mt-lg-4">
                  {localStorage.getItem("is_content_creator") == 2 ? (
                    <div className="left-half post-write">
                      ...
                      <Button onClick={() => setAddLinkModal(true)}>
                        <Image
