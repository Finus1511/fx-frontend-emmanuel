...
export function updateSingleLiveVideoStart(data) {
  return {
    type: UPDATE_SINGLE_LIVE_VIDEOS_START,
    data,
  };
}

export function updateSingleLiveVideoSuccess(data) {
  return {
    type: UPDATE_SINGLE_LIVE_VIDEOS_SUCCESS,
    data,
  };
}

export function updateSingleLiveVideoFailure(error) {
  return {
    type: UPDATE_SINGLE_LIVE_VIDEOS_FAILURE,
    error,
  };
}
