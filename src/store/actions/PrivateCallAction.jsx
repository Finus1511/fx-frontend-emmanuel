...
export function fetchMorecallRequestSentUserStart(data) {
  return {
    type:  FETCH_MORE_CALL_REQUEST_SENT_USER_START,
    data,
  };
}
...
export function fetchMoreCallHistoryUserStart(data) {
  return {
    type: FETCH_MORE_CALL_HISTORY_USER_START,
    data,
  };
}
...
export function fetchMoreCallRequestReceivedModelStart(data) {
  return {
    type:   FETCH_MORE_CALL_REQUEST_RECEIVED_MODEL_START,
    data,
  };
}
...
export function fetchMoreAudioCallHistoryUserStart(data) {
  return {
    type:FETCH_MORE_AUDIO_CALL_HISTORY_USER_START,
    data,
  };
}
