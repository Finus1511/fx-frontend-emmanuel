...
export function digitalProductDownloadStart(data) {
  return {
    type: DIGITAL_PRODUCT_DOWNLOAD_START,
    data,
  };
}

export function digitalProductDownloadSuccess(data) {
  return {
...
export function digitalProductDownloadFailure(error) {
  return {
...
export function digitalProductPaymentWalletStart(data) {
  return {
    type: DIGITAL_PRODUCT_PAYMENT_WALLET_START,
    data,
  };
}

export function digitalProductPaymentWalletSuccess(data) {
  return {
    type: DIGITAL_PRODUCT_PAYMENT_WALLET_SUCCESS,
    data,
  };
}

export function digitalProductPaymentWalletFailure(error) {
  return {
    type: DIGITAL_PRODUCT_PAYMENT_WALLET_FAILURE,
    error,
  };
}
