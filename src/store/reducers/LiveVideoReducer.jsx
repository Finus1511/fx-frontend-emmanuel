...
const LiveVideoReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    // update single live video

    case UPDATE_SINGLE_LIVE_VIDEOS_START:
      return {
        ...state,
        updateSingleLiveVideo: {
          data: {},
    ...
    case UPDATE_SINGLE_LIVE_VIDEOS_SUCCESS:
      return {
        ...state,
        updateSingleLiveVideo: {
          data: action.data,
    ...
    case UPDATE_SINGLE_LIVE_VIDEOS_FAILURE:
      return {
        ...state,
        updateSingleLiveVideo: {
          data: {},
