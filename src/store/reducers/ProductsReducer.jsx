...
const ProductsReducer = (state = initialState, action) => {
	switch (action.type) {
		...
		case DIGITAL_PRODUCT_DOWNLOAD_START:
			return {
				...state,
				digitalProductDownload: {
					data: {},
		...
		case DIGITAL_PRODUCT_PAYMENT_WALLET_START:
			return {
				...state,
				digitalProductPaymentWallet: {
					data: {},
		...
		case DIGITAL_PRODUCT_PAYMENT_WALLET_SUCCESS:
			return {
				...state,
				digitalProductPaymentWallet: {
					data: action.data,
		...
		case DIGITAL_PRODUCT_PAYMENT_WALLET_FAILURE:
			return {
				...state,
				digitalProductPaymentWallet: {
					data: {},
